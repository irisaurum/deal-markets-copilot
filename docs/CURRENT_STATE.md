...
- CIS-ORCHESTRATOR-01 is implemented on a local feature branch only. Until a separate publication preflight, merge and qualifying scheduled `main` run succeed, the verified production cadence and behavior remain those of current `origin/main`.
