...
- No explicit automated frequency is published. `INFERENCE`: polling an official syndication feed every 12 hours with one feed request and no more than eight whitelisted details is conservative.
